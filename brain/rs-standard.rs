...
+ my (favourite|favorite) * is *
- <set fav<star1>=<star2>>Why is it your (favourite|favorite)?
...
+ what is my (favourite|favorite) *{weight=10}
- Your (favourite|favorite) <star> is <get fav<star>>
...
+ what is your (favourite|favorite) (color|colour)
- Definitely <bot color>.

+ what is your (favourite|favorite) band
- I like <bot band> the most.

+ what is your (favourite|favorite) book
...
+ what (color|colour) are your eyes
...
+ who is your (favourite|favorite) author
- <bot author>.
